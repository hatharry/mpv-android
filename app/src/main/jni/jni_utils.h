...
extern jclass java_Integer, java_Boolean, java_Double;
extern jmethodID java_Integer_init, java_Integer_intValue, java_Boolean_init, java_Boolean_booleanValue, java_Double_init, java_Double_doubleValue;
